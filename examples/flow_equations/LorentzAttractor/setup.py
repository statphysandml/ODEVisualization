...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        subprocess.check_call(['cmake', '--build', '.', '--target', 'lorentzattractor_python'] + build_args, cwd=self.build_temp)
...
setup(
    ...
    ext_modules=[CMakeExtension(
        name='lorentzattractorsimulation'
    )],
    ...
    package_dir={"lorentzattractor": "python_pybind"},
    packages=["lorentzattractor"]
)
