...
namespace odesolver {
    namespace pybind {
        ...
        {   
            py::class_<odesolver::modes::Evolution, std::shared_ptr<odesolver::modes::Evolution>>(m, "Evolution")
            .def("evolve_const", &odesolver::modes::Evolution::evolve_const<StepperClass>, "stepper"_a, "coordinates"_a, "start_t"_a, "end_t"_a, "delta_t"_a)
        ...
        void init_evolution_observer(py::module &m)
        {
            py::class_<odesolver::modes::Evolution, std::shared_ptr<odesolver::modes::Evolution>>(m, "Evolution")
            .def("evolve_const", &odesolver::modes::Evolution::evolve_const<StepperClass, Observer>, "stepper"_a, "coordinates"_a, "start_t"_a, "end_t"_a, "delta_t"_a, "observer"_a, "equidistant_time_observations"_a=true, "observe_every_ith_time_step"_a=1)
        ...
        void init_evolution_observer(py::module &m)
        {
            init_evolution_observer<StepperClass, odesolver::evolution::DivergentFlow>(m);
            init_evolution_observer<StepperClass, odesolver::evolution::NoChange>(m);
            init_evolution_observer<StepperClass, odesolver::evolution::OutOfRangeCondition>(m);
            init_evolution_observer<StepperClass, odesolver::evolution::Intersection>(m);
            // init_evolution_observer<StepperClass, 
            // odesolver::evolution::TrajectoryObserver>(m);
            init_evolution_observer<StepperClass, odesolver::evolution::EvolutionObserver>(m);
        }
