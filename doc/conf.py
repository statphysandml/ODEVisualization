...
project = 'ODEVisualization'
copyright = '2022, Lukas Kades'
author = 'Lukas Kades'
...
breathe_projects = {}
breathe_default_project = "ODEVisualization"
...
if read_the_docs_build:
    ...
    subprocess.check_call("cmake --build . --target odevisualization_doxygen".split(), cwd=builddir)
    breathe_projects["ODEVisualization"] = os.path.join(builddir, "doc", "xml")
