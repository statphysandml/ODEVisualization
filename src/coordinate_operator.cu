#include "../include/odesolver/coordinate_operator.hpp"
...
void CoordinateOperator::compute_jacobians()
{
    ...
    jacobians_ = Jacobians(jacobian_elements_.transpose_device_data());
...
Jacobians CoordinateOperator::get_jacobians() const
{
    return jacobians_;
}
