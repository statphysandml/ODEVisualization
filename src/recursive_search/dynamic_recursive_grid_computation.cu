...
namespace odesolver {
    namespace recursivesearch {
            ...
            const std::vector<std::pair<cudaT, cudaT>> variable_ranges, VertexMode vertex_mode)
        {
            ...
            hypercubes_ = odesolver::gridcomputation::GridComputation(n_branches_per_depth, variable_ranges);
        ...
        void DynamicRecursiveGridComputation::next(devdat::DevDatC &vertices)
        {
            ...
            // Expand collections
            odesolver::gridcomputation::GridComputationWrapper grid_computation_wrapper(expected_number_of_cubes_, expected_maximum_depth_);
        ...
        odesolver::gridcomputation::GridComputation& DynamicRecursiveGridComputation::get_hypercubes()
        {
            return hypercubes_;
        }
    }
