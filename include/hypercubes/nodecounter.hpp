...
template <typename T> std::vector<int> NodeCounter<T>::objects_created_(std::vector<int> (1000, 0));
template <typename T> std::vector<int> NodeCounter<T>::objects_alive_(std::vector<int> (1000, 0));
